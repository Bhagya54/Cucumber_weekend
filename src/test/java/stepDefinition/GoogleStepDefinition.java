 ...
 * 
 * 
 * public class GoogleStepDefinition { WebDriver driver;
 * 
 ...
 * }
 * 
 * @And("Navigate to google.com") public void navigate_to_google_com() {
 * driver.get("https://google.com"); }
 * 
 * @When("Entered a search keyword") public void entered_a_search_keyword() {
 * driver.findElement(By.name("q")).sendKeys("Selenium WebDriver"); }
 * 
 * @And("Hit the Enter button") public void hit_the_enter_button() { new
 * Actions(driver).sendKeys(Keys.ENTER).perform(); }
 * 
 * @Then("Google search results appear") public void
 * google_search_results_appear() {
 * Assert.assertTrue(driver.getTitle().contains("WebDriver"));
 * System.out.println("Passed"); }
 * 
 * @Then("Close the browser") public void close_the_browser() { driver.close();
 * }
 * 
 * }
 */